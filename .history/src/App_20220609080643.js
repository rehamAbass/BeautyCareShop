...
const App = () => {
  ...
  //==================================================
   const saveProds = async (prods) => {  
    const response = await axios.put(
      "http://localhost:8000/products",prods
    );
  }

  const  updateProds = async(updatedarray)=>{
     const response = await axios.put(
      "http://localhost:8000/products",updatedarray
    );
  }
  //=============================================
  ...
  const addProduct=(product)=>{
     ...
     if(updatePro.length>0){
       ...
       updatePro.amount =updatePro.amount +1;
        ...
        newProductToAdd.amount = product.amount +1 ;
